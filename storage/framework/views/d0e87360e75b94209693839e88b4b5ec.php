...
<?php endif; ?>
             <?php $__env->slot('title', null, []); ?> 
                <?php echo e(__('Benvenuto! Effettua il login al tuo account.')); ?>
...
<?php endif; ?>
            ...
            <div class="flex items-center justify-end mt-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('password.request')): ?>
                    <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500" href="<?php echo e(route('password.request')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\b2b.partylegacy.it\resources\views/auth/login.blade.php ENDPATH**/ ?>