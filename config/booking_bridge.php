...
return [
    ...
    'geocoding_user_agent' => env('BOOKING_BRIDGE_GEOCODING_USER_AGENT'),
    'geocoding_contact_email' => env('BOOKING_BRIDGE_GEOCODING_CONTACT_EMAIL'),
