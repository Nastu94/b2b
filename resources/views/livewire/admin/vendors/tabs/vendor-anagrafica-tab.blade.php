        ...
        <div class="bg-white border border-slate-200 rounded-xl shadow-sm p-6 mb-6">
            ...
            <div class="mt-4 flex items-start gap-6">
                <div class="shrink-0">
                    ...
                    @elseif ($vendorAccount->profile_image_path)
                        <img src="{{ route('media.public', ['path' => $vendorAccount->profile_image_path]) }}" alt="Logo" class="h-24 w-24 rounded-lg object-cover border border-slate-200">
                    @else
                ...
                <div class="flex-1">
                    ...
                    @else
                        <p class="mt-2 text-sm text-slate-500">Clicca su Modifica per caricare una nuova immagine.</p>
                    @endif
                </div>
            </div>
        </div>
